...
import 'package:thumbprint/presentation/features/VoteScreen/item/vice_president_item.dart';

import '../../../controllers/candidates_controller.dart';

class VicePresidentElectionItem extends StatefulWidget{


  VicePresidentElectionItem({Key? key,  }) : super(key: key);

  @override
  State<VicePresidentElectionItem> createState() => _VicePresidentElectionItemState();
}

class _VicePresidentElectionItemState extends State<VicePresidentElectionItem> {

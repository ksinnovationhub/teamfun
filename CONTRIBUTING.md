...
1. Fork the repo and create your branch from `dev`. Branch name should follow this convention - feature/[name_of_feature] or bug/[name_of_bug]
2. If you've added code that should be tested, add tests.
3. If you've changed APIs, update the documentation.
4. Make sure  you clean your code. Run `./flutter clean` to fix any issues that might arise
...
## Report bugs using Github's [issues](https://github.com/ksinnovationhub/teamfun/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/ksinnovationhub/teamfun/issues/new); it's that easy!
...
* Use tabs for indentation rather than 4 spaces

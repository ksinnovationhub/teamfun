...
/***/ "./src/assets/scripts/pages/power-reports.js":
/*!***************************************************!*\
  !*** ./src/assets/scripts/pages/power-reports.js ***!
  \***************************************************/
/*! no static exports found */
...
document.addEventListener('DOMContentLoaded', function (e) {
  const powerReportsPage = document.getElementById('power-reports-page');

  if (powerReportsPage) {
    // old slider
    // const analysisSlider = document.querySelector(
    //   '.power-reports-analysis-slider'
    // );
    // if (analysisSlider) {
    //   const analysisImagesSlider = tns({
    //     container: '.power-reports-analysis-slider',
    //     items: 1.5,
    //     center: true,
    //     mouseDrag: false,
    //     controls: false,
    ...
    //     loop: false
    //   });
    //   const analysisSliderItemsLinks = document.querySelectorAll(
    //     '.power-reports-analysis-slider-item a'
    //   );
    //   analysisSliderItemsLinks.forEach((itemLink) => {
    //     itemLink.onclick = (event) => {
    //       event.preventDefault();
    //       let imgsrc = itemLink.href;
    //       basicLightbox.create('<img src="' + imgsrc + '">').show();
    //     };
    //   });
    // }
    const analysisSlider = document.querySelector('.power-reports-analysis-slider');

    if (analysisSlider) {
      const itemsCount = window.screen.width > 1200 ? 1.5 : 1.5;
      const isCenterMode = window.screen.width > 1200 ? true : false;
      const slider = tns({
        container: '.power-reports-analysis-slider',
        items: itemsCount,
        mouseDrag: true,
    ...
    const reportingSlider = document.querySelector('.power-reports-reporting-slider');

    if (reportingSlider) {
      const itemsCount = window.screen.width > 1200 ? 2.5 : 1.5;
      const isCenterMode = window.screen.width > 1200 ? true : false;
      const slider = tns({
        container: '.power-reports-reporting-slider',
        items: itemsCount,
        center: true,
        mouseDrag: true,
        controls: false,
...
/***/ "./src/assets/styles/pages/power-reports.scss":
/*!****************************************************!*\
  !*** ./src/assets/styles/pages/power-reports.scss ***!
  \****************************************************/
/*! no static exports found */
...
/***/ 15:
/*!******************************************************************************************************!*\
  !*** multi ./src/assets/scripts/pages/power-reports.js ./src/assets/styles/pages/power-reports.scss ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\Nanie\Desktop\www\agorapulse-www-static\src\assets\scripts\pages\power-reports.js */"./src/assets/scripts/pages/power-reports.js");
module.exports = __webpack_require__(/*! C:\Users\Nanie\Desktop\www\agorapulse-www-static\src\assets\styles\pages\power-reports.scss */"./src/assets/styles/pages/power-reports.scss");


/***/ })

/******/ });
//# sourceMappingURL=power_reports.js.map
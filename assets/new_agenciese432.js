...
/***/ "./src/assets/scripts/pages/new-agencies.js":
/*!**************************************************!*\
  !*** ./src/assets/scripts/pages/new-agencies.js ***!
  \**************************************************/
...
document.addEventListener('DOMContentLoaded', function (e) {
  //New agencies competitors pricing accordion
  let competitorsRows = document.querySelectorAll('.competitor-row');

  if (competitorsRows.length > 0) {
    competitorsRows.forEach(item => {
      item.addEventListener('mouseenter', event => {
        item.classList.toggle('open-pricing');
      });
      item.addEventListener('mouseleave', event => {
        item.classList.toggle('open-pricing', false);
      });
    });
  }
...
/***/ "./src/assets/styles/pages/new-agencies.scss":
/*!***************************************************!*\
  !*** ./src/assets/styles/pages/new-agencies.scss ***!
  \***************************************************/
/*! no static exports found */
...
/***/ 10:
/*!****************************************************************************************************!*\
  !*** multi ./src/assets/scripts/pages/new-agencies.js ./src/assets/styles/pages/new-agencies.scss ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\Nanie\Desktop\www\agorapulse-www-static\src\assets\scripts\pages\new-agencies.js */"./src/assets/scripts/pages/new-agencies.js");
module.exports = __webpack_require__(/*! C:\Users\Nanie\Desktop\www\agorapulse-www-static\src\assets\styles\pages\new-agencies.scss */"./src/assets/styles/pages/new-agencies.scss");


/***/ })

/******/ });
//# sourceMappingURL=new_agencies.js.map